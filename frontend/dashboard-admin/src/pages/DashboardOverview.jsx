  ...
  return (
    <div className="pt-10 pb-24">
      <header className="mb-10">
        <h1 className="text-3xl font-normal text-white">Visão <span className="text-[#10B981] font-bold">Estratégica</span></h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <KpiCard label="Leads Hot" value={metrics?.hot || 0} sub="Alta Intenção" color="text-[#10B981]" />
        <KpiCard label="Taxa de Conversão" value={`${metrics?.taxaConversao || 0}%`} sub="Leads Vendidos" color="text-green-500" />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-[#0F172A] border border-[#1F2937] p-10 rounded-[2.5rem] shadow-2xl">
          <h3 className="text-[10px] text-gray-600 uppercase font-black mb-8 tracking-widest">Qualidade da Base</h3>
          <div className="space-y-6">
            <ProgressBar label="Hot (Prontos)" value={metrics?.hot} total={metrics?.total} color="bg-[#10B981]" />
        ...
        <div className="bg-[#0F172A] border border-[#1F2937] p-10 rounded-[2.5rem] shadow-2xl flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-[10px] text-[#10B981] font-black uppercase mt-2">Contratos Fechados</p>
          </div>
        </div>
      </div>
    </div>
...
function KpiCard({ label, value, sub, color }) {
  return (
    <div className="bg-[#0F172A] border border-[#1F2937] p-8 rounded-[2rem] shadow-xl">
