...
// v4: cores e logo originais + layout organizado
// ============================================================
...
const IconRanking = () => (
  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6 9H4a2 2 0 00-2 2v9a2 2 0 002 2h2a2 2 0 002-2v-9a2 2 0 00-2-2z"/>
    <path d="M13 5h-2a2 2 0 00-2 2v13a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2z"/>
    <path d="M20 2h-2a2 2 0 00-2 2v16a2 2 0 002 2h2a2 2 0 002-2V4a2 2 0 00-2-2z"/>
  </svg>
);
const IconAnalytics = () => (
  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
...
const IconMarcas = () => (
  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
    <path d="M3 21V7l9-4 9 4v14M9 21V12h6v9M3 10h18"/>
  </svg>
);
const IconSegmentos = () => (
  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
    <circle cx="12" cy="12" r="9"/>
    <path d="M12 3v9l6.36 6.36M12 12L5.64 18.36"/>
  </svg>
);
const IconTeam = () => (
  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
...
export default function Sidebar({ mobileOpen, setMobileOpen }) {
  ...
  const sidebarContent = (
    <aside className="flex flex-col items-center h-full bg-[#0F172A] border-r border-white/5 w-32 py-8">

      {/* Logo oficial */}
      <a href="/dashboard" onClick={handleNavClick} className="mb-8 px-3" title="LeadCapture Pro">
        <LogoIcon size={96} />
      </a>

      {/* Nav */}
      <nav className="flex flex-col w-full px-3 flex-1 overflow-y-auto scrollbar-none gap-0">
            ...
            <div key={group.label} className="mb-3">
              ...
              {visibleItems.map((item) => (
                <NavLink
                  ...
                  title={item.label}
                  className={({ isActive }) => `
                    flex flex-col items-center gap-1.5 p-2.5 rounded-2xl mb-0.5
      ...
      {/* Logoff + Avatar */}
      <div className="mt-auto pt-3 border-t border-white/5 w-full px-3">
        <button
          onClick={() => setConfirmLogoff(true)}
          title="Sair do sistema"
          className="flex flex-col items-center gap-1.5 p-2.5 rounded-2xl mb-2 w-full text-gray-600 hover:bg-red-500/10 hover:text-red-400 transition-all duration-150"
        >
          <span className="leading-none"><IconLogoff /></span>
